    ...
    <div class="container body">
        <div class="main_container">
                        ...
                        @if(Auth::guard('account')->user()->type == 3)
                            ...
                            <ul class="nav side-menu">
                                ...
                                <li><a  href="{{ route('subProfile',['subdomain' =>$info['subdomain']]) }}"><i class="fa fa-user"></i> Quản lý Tài khoản</a></li>
                                 <li><a  href="{{ route('subConfig',['subdomain' =>$info['subdomain']]) }}"><i class="fa fa-cogs"></i> Cài Đặt Web</a></li>
            ...
            <div class="right_col" role="main">
                ...
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Danh sách Nhân viên<small></small></h2>
                    <ul class="nav navbar-right panel_toolbox">
                      <a href="#" class="btn btn-primary btn-xs" data-target="#addUserMainmodal" data-toggle="modal" data-backdrop="static" ><i class="fa fa-folder"></i> Thêm Nhân viên </a>
                    </ul>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    ...
                    <table id="responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      @foreach ($users as $user)
                            ...
                            <form id="deleteUser{{$user->id}}" action="{{ route('subStaffManageSubmit',['subdomain' =>$info['subdomain']]) }}" method="POST" style="display: none;">
                                            {{ csrf_field() }}
...
<div class="modal fade" id="addUserMainmodal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
        ...
        <button type="button" class="close" id="closeDialog" onclick="removeMessage()" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span>
          ...
          <h1>Thêm Nhân viên</h1><br>
          <form class="form-horizontal" role="form" method="POST" action="{{ route('subStaffManageSubmit',['subdomain' =>$info['subdomain']]) }}">
                        {{ csrf_field() }}
                        ...
                        <input type="submit" name="Register" class="loginmodal-submit " value="Thêm Nhân viên">
      ...
      <div class="modal fade" id="viewUserMainmodal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
        ...
        <button type="button" class="close" id="closeDialog" onclick="removeMessage()" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span>
          ...
          <h1>Xem chi tiết Nhân viên</h1><br>
          <form class="form-horizontal" role="form" method="POST" action="{{ route('subStaffManageSubmit', ['subdomain' =>$info['subdomain']]) }}">
                        {{ csrf_field() }}
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12  form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                            <input id="e_submit" type="submit" name="Register" class="loginmodal-submit" value="Chỉnh sửa Nhân viên">
                        </div>
                         <div class="col-md-6 col-sm-6 col-xs-12  form-group{{ $errors->has('password') ? ' has-error' : '' }}">
